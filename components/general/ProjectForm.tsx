    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div>
        ...
        <input
          ...
          className="w-full border rounded p-2 bg-transparent focus:ring-2 focus:ring-primary transition"
          required
        />
      </div>
      <div>
      ...
      <button
        type="submit"
        className="w-full bg-gradient-to-r from-primary to-secondary text-white px-4 py-2 rounded hover:scale-105 transition"
      >
        Add Project
      </button>
    </form>
